...
export class ProjectsComponent {
  ...
  projectData = [
    ...
    //   url: 'https://ring-of-fire-1cf24.firebaseapp.com/',
    //   gitLink: 'https://github.com/Bossi1979/ring_of_fire',
    // },
    {
      imgSrc: '../../assets/img/projects/portfolio_dabubble.png',
      title: 'DA Bubble (coming soon)',
      skills: 'Angular | Typescript | HTML | SCSS | Firebase | Material Design',
      description: `"BA Bubble Chat App offers an intuitive platform for teams to communicate and collaborate seamlessly. Similar to Slack, it enables the exchange of messages across different channels, allowing teams to organize their conversations by projects, departments, or topics. The app also supports private messages, group chats, and file sharing to enhance the efficiency of teamwork."`,
      url: 'https://ring-of-fire-1cf24.firebaseapp.com/',
      gitLink: 'https://github.com/Bossi1979/ring_of_fire',
    },
  ];
